...
- [x] Contrato `AGENTS.md` §7: id = timestamp UTC, formato y display
  - **Resolved:** `2026-06-13T15:09:00Z`
- [x] `sl new`: generar id desde `created` (quitar `id_digits`)
  - **Resolved:** `2026-06-13T15:09:30Z`
- [x] Visor: mostrar id abreviado
  - **Resolved:** `2026-06-13T15:10:00Z`
- [x] Migrar changes existentes (ids + `depends_on`)
  - **Resolved:** `2026-06-13T15:10:55Z`
- [x] Tests: generación de id y unicidad
  - **Resolved:** `2026-06-13T15:10:30Z`

## Log

- **2026-06-13T15:04:02Z** `[note]` Creado en draft tras detectar colisión de ids
  secuenciales en escenarios multi-dev. Decisión: timestamp UTC `YYYYMMDD-HHMMSS`.
- **2026-06-13T15:08:09Z** `[note]` Aprobado (draft → approved). Implementación: primero.
- **2026-06-13T15:10:55Z** `[note]` Implementado. `id` ahora `YYYYMMDD-HHMMSS` derivado de
