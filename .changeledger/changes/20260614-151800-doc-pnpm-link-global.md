...
- [x] README §Development: bloque de `pnpm link --global` / `sl --help` / `pnpm unlink --global` con una línea de contexto (interino hasta el publish npm #222920)
  - **Resolved:** `2026-06-14T15:33:58Z`

## Log

- **2026-06-14T15:27:16Z** `[status]` draft → approved
- **2026-06-14T15:33:43Z** `[status]` approved → in-progress
- **2026-06-14T15:33:43Z** `[owner]` set: Roberto Ruiz (auto)
