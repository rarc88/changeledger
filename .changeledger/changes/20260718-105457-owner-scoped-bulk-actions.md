...
- **2026-07-18T10:54:57Z** `[note]` Draft autorizado por el humano tras detectar que una operación pedida por owner podía ampliar silenciosamente su alcance al archivar candidatos de otras personas.
- **2026-07-18T11:18:34Z** `[status]` draft → approved
- **2026-07-18T12:16:16Z** `[status]` approved → in-progress
- **2026-07-18T12:16:16Z** `[owner]` set: Roberto Ruiz (auto)
- **2026-07-18T12:24:37Z** `[note]` Implementado selector compartido para preview/archive, filtros exactos --owner/--unowned, guardas CLI y contrato de graduación individual; pnpm verify pasa con 687 tests.
