...
- [x] `loadRepo` adjunta el texto crudo `text` a cada change
  - **Criteria:** CR1
  - **Resolved:** `2026-06-14T11:43:27Z`
- [x] `checkRepo` escanea `text` y reporta marcadores con su línea
  - **Criteria:** CR1, CR2
  - **Resolved:** `2026-06-14T11:43:27Z`
- [x] Tests: detecta los tres marcadores; repo limpio no falsea
  - **Criteria:** CR1, CR2
  - **Resolved:** `2026-06-14T11:43:27Z`
