...
- **2026-06-17T19:00:06Z** `[note]` Detectado en auditoría. `fb8f6ce` introdujo el lock pero sin tests de branches de error. `STALE_LOCK_MS` nombre engañoso también reportado.
- **2026-06-17T19:39:19Z** `[note]` Absorbe decisión de documentación de estrategia de lock de `20260617-190011` (descartado por fusión).
- **2026-06-17T20:04:26Z** `[status]` draft → approved
- **2026-06-17T20:28:02Z** `[status]` approved → in-progress
- **2026-06-17T20:28:02Z** `[owner]` set: raruiz-hiberuscom (auto)
- **2026-06-17T20:30:42Z** `[status]` in-progress → in-review
- **2026-06-17T20:31:03Z** `[review]` in-review → done (delegated subagent, clean context)
